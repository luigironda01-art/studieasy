...
export function Sidebar() {
  ...
  const sidebarContent = (
    <div className="flex flex-col h-full">
      ...
      {/* Library Section */}
      <div className="flex-1 overflow-y-auto px-3 py-2" data-tutorial="sidebar-library">
                  ...
                  <div className={`flex items-center gap-2 px-2 py-1.5 rounded-lg text-xs transition-all ${
                    ...
                    {gen.status === "completed" && (
                      <button
                        ...
                        className="text-emerald-400 shrink-0 hover:text-red-400 transition-colors"
                        title="Rimuovi"
                      >
                        <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
